...
const BlogSection = ({
  ...
  return (
    <section className="mt-[110px]">
      <div
        className={`relative flex justify-between lg:justify-normal md:flex-col sm:flex-col`}
      >
        <p
          className={`absolute text-[24px] text-bannerTextColor text-right font-light ${
            align == "left" || isMD ? "right-0" : "left-0"
          } top-[-60px]`}
        >
          Blog
        </p>
        ...
        <div
          className={`w-[600px] md:w-full sm:w-full flex flex-col justify-between 
											md:mt-[30px] sm:mt-[30px] ${align == "left" && !isMD ? "lg:ml-[50px]" : ""}`}
        >
          <div>
            <p className="font-arial font-bold text-bannerTextColor text-[36px] lg:text-[30px] sm:text-[30px]">
              {title}
            </p>
            <div className="text-justify">
              <span
                className={`font-arial font-light text-[32px] lg:text-[26px] sm:text-[26px] 
