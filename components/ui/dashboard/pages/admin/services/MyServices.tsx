...
export default function MyServices() {
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div>
        <div
          className=" mt-8 px-20 py-2 font-bold bg-primary text-[20px] text-white rounded-md cursor-pointer"
          onClick={() => setOpen(true)}
        >
          Select
        </div>
      </div>
      <ServiceCatelogConfirmModal open={open} setModalOpen={setOpen} />
    </div>
  );
}
