...
export default function Careplandlg({
  open,
  setIsOpenModal,
}: {
  open: boolean;
  ...
  return (
    <div style={{ display: open ? "block" : "none" }}>
      <div
        className="p-4 w-full h-full left-0 top-0 flex justify-center"
        style={{
          position: "fixed",
      ...
      >
        <div className="w-4/5  bg-white p-4 flex flex-col justify-center">
          <div
            className=" mt-4 text-center text-[24px] font-bold"
            style={{ color: "#282828" }}
          >
            Edit Care Plan
          </div>
          ...
          <div
            className="mt-5 text-center text-[16px]"
            style={{ color: "#828282" }}
          >
