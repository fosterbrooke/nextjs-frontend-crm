        ...
        <div className="mt-[25px]">
          <div className="text-justify">
            <span className="text-adDescBigSize md:text-adDescSmallSize sm:text-adDescSmallSize text-bannerTextColor font-arial font-light">
              At Seasoned Senior Home Care Agency, we have a well-defined
              process for providing care to our seniors. Here&apos;s how our
              agency works and how we implement our care services:
            </span>
          </div>
          <Image
            alt="howitworks"
          ...
          <div>
            ...
            <div className="mt-[50px] text-justify">
              <span className="text-adDescBigSize md:text-adDescSmallSize sm:text-adDescSmallSize text-bannerTextColor font-arial font-light">
                At Seasoned Senior Home Care Agency, our priority is to provide
                compassionate, personalized, and professional care to our
                seniors. Through our well-defined process, trained caregivers,
                and ongoing monitoring, we ensure that our seniors receive the
                highest quality of care that promotes their independence,
