        ...
        <div className="mt-[25px]">
          ...
          <div className="text-justify mt-[50px]">
            <span className="text-adDescBigSize md:text-adDescSmallSize sm:text-adDescSmallSize text-bannerTextColor font-arial font-light">
              At Seasoned Senior Care Agency, we make it easy for seniors and
              their families to schedule a meeting with our senior care
              representatives. Here&apos;s how seniors looking for care can
              schedule a meeting to speak with a representative from our agency:
            </span>
          </div>
          <div>
            {scheduleAds.map((scheduleAd, idx) => {
              return (
                <div
                  key={`scheduleameeting_paragraph_${idx}`}
            ...
            <div className="mt-[50px] text-justify">
              <span className="text-adDescBigSize md:text-adDescSmallSize sm:text-adDescSmallSize text-bannerTextColor font-arial font-light">
                At Seasoned Senior Care Agency, we prioritize open and
                transparent communication with seniors and their families. We
                strive to provide a seamless and supportive experience
                throughout the process of scheduling a meeting, ensuring that
                all their questions are answered, and they feel comfortable and
                confident in choosing our agency for their care needs.
              </span>
            </div>
          </div>
