        ...
        <div className="mt-[25px]">
          ...
          <div className="text-justify mt-[50px]">
            <span className="text-adDescBigSize md:text-adDescSmallSize sm:text-adDescSmallSize text-bannerTextColor font-arial font-light">
              This Privacy Policy (&quot;Policy&quot;) explains how Seasoned
              Senior Home Care Agency (&quot;we,&quot; &quot;us,&quot; or
              &quot;our&quot;) collects, uses, discloses, and protects the
              personal information of individuals (&quot;you&quot; or
              &quot;users&quot;) who access or use our website and services
              (collectively referred to as the &quot;Services&quot;). We are
              committed to protecting your privacy and ensuring the security of
              your personal information. By accessing or using our Services, you
          ...
          <div>
            {privacypolicyAds.map((privacypolicyAd, idx) => {
              ...
              if (
                (idx > 0 &&
                  privacypolicyAds[idx - 1].title?.trim() ==
                    privacypolicyAd.title?.trim()) ||
                (cnt == 0 &&
                  idx < privacypolicyAds.length - 1 &&
                  privacypolicyAds[idx + 1].title == privacypolicyAd.title)
              ) {
                if (cnt != 0) {
                  isFirst = false;
                }
              ...
              return (
                <div
                  key={`privacypolicy_paragraph_${idx}`}
            ...
            <div className="mt-[50px] text-justify">
              <span className="text-adDescBigSize md:text-adDescSmallSize sm:text-adDescSmallSize text-bannerTextColor font-arial font-light">
                ...
                understood, and agreed to the terms and practices described in
                this Privacy Policy.
              </span>
            </div>
          </div>
