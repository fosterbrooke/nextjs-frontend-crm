        ...
        <div className="mt-[25px]">
          ...
          <div className="text-justify mt-[50px]">
            <span className="text-adDescBigSize md:text-adDescSmallSize sm:text-adDescSmallSize text-bannerTextColor font-arial font-light">
              These Terms of Use (&quot;Agreement&quot;) govern your access and
              use of the Seasoned Senior Home Care Agency website, services, and
              any related content or materials (collectively referred to as the
              &quot;Services&quot;). By accessing or using our Services, you
              agree to be bound by this Agreement. If you do not agree with any
              provision of this Agreement, please refrain from using our
              Services.
            </span>
          </div>
          <div>
            {termsofuseAds.map((termsofuseAd, idx) => {
              ...
              if (
                (idx > 0 &&
                  termsofuseAds[idx - 1].title?.trim() ==
                    termsofuseAd.title?.trim()) ||
                (cnt == 0 &&
                  idx < termsofuseAds.length - 1 &&
                  termsofuseAds[idx + 1].title == termsofuseAd.title)
              ) {
                if (cnt != 0) {
                  isFirst = false;
                }
            ...
            <div className="mt-[50px] text-justify">
              <span className="text-adDescBigSize md:text-adDescSmallSize sm:text-adDescSmallSize text-bannerTextColor font-arial font-light">
                ...
                please [Link to the contact us page].
                <br />
                <br />
