        ...
        <div className="mt-[25px]">
          ...
          <div className="text-justify mt-[50px]">
            <span className="text-adDescBigSize md:text-adDescSmallSize sm:text-adDescSmallSize text-bannerTextColor font-arial font-light">
              At Seasoned Senior, we understand the importance of providing
              engaging and enjoyable experiences for seniors. That&apos;s why we
              organize outdoor events within various locations, creating
              opportunities for seniors to connect, socialize, and participate
              in activities that promote well-being and a sense of community.
              Here&apos;s how we organize outdoor events for seniors:
            </span>
          </div>
          <div>
            ...
            <div className="mt-[50px] text-justify">
              <span className="text-adDescBigSize md:text-adDescSmallSize sm:text-adDescSmallSize text-bannerTextColor font-arial font-light">
                At Seasoned Senior, we believe in the power of outdoor events to
                enrich seniors&apos; lives, foster social connections, and
                promote overall well-being. Through meticulous planning,
                engaging activities, and a focus on seniors&apos; needs, we
                strive to create memorable and meaningful experiences that
                enhance their quality of life and bring joy to their journey.
                <br />
                <br />
                Our upcoming senior events will be listed here according to
                location.
              </span>
            </div>
          </div>
