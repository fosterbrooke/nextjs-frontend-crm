      ...
      <div className="mt-[25px]">
        <div className="text-center">
          <span className="text-adDescBigSize md:text-adDescSmallSize sm:text-adDescSmallSize text-bannerTextColor font-arial font-light">
            “Seasoned senior is a platform that provides senior care and
            connects caregivers with seniors looking for care”
          </span>
        </div>
        <Image
          alt="aboutus"
        ...
        <div className="mt-[50px] text-justify sm:text-left">
          <span className="text-adDescBigSize md:text-adDescSmallSize sm:text-adDescSmallSize text-bannerTextColor font-arial font-light">
            ...
            while receiving the care they need. Our services are delivered by
            trained professionals, such as caregivers, nurses, or home health
            aides.
            <br />
            <br />
          </span>
