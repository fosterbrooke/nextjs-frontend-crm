    ...
    <>
      <WithRightBG imgpathname="/images/registration_img_3.png">
        ...
        <div className="flex ml-8 mt-[145px] fixed">
          <BackBtn onClicked={() => router.push("/auth/app/caregiver/2")} />
        </div>
        ...
        <div className="px-8 mx-auto mt-8 sm:w-full">
          <div className="text-center">
            ...
            <div className="text-base text-distlineColor font-arial font-normal mt-4 mx-7">
              &nbsp;&nbsp;&nbsp; Can you provide assistance with mobility and
              physical assistance?
            </div>
          ...
          <div className="mx-5 mt-6 px-7 pb-7">
            <InputField
              type="text"
              title="List of services required you can provide"
        ...
        <div className="flex justify-between mx-8 mt-auto">
          ...
          <ContinueBtn onClicked={() => router.push("/auth/app/caregiver/4")} />
        </div>
      </WithRightBG>
    </>
  );
