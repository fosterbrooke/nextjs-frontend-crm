        ...
        >
          ...
          <div className="w-[75%]">
            ...
            <div className="text-[20px] text-distlineColor font-arial mt-[14px] mx-7">
              ...
              part-time basis under this Contract. In this capability, the
            ...
            <div className="text-[20px] text-distlineColor font-arial mt-[14px] mx-7">
              <li>
                ...
                employee under this Agreement, The employer will pay the
                employee $25.00 per hour. The amount will be paid to the
                employee weekly on Wednesdays.
              </li>
              <li>
              ...
              <li>
                ...
                additional compensation for services rendered under this
                agreement on the following basis: if services rendered go beyond
                the set schedule, Seasoned Senior will further compensate for
                time spent at $25 per hour. Any additional compensation or
                bonuses paid to the Employee shall be paid at the sole
            ...
            <div className="text-[20px] text-distlineColor font-arial mt-[14px] mx-7">
              ...
              employee will not accept cash from the client for any reason
            ...
            <div className="text-[20px] text-distlineColor font-arial mt-[14px] mx-7">
              Employee shall not be entitled to paid time off as required by
            ...
            <div className="text-[20px] text-distlineColor font-arial mt-[14px] mx-7">
              The Employee shall adhere to the confidentiality agreement
              outlined in the attached terms and conditions.
            </div>
            <div className="text-left font-bold text-[24px] text-textdarkColor font-arial mt-6 mx-7">
              Termination
            </div>
            <div className="text-[20px] text-distlineColor font-arial mt-[14px] mx-7">
              ...
              fulfilling their duties and obligations in good faith with the
              best efforts. At the time of termination, Employee agrees to
              return all Employer property, including but not limited to
              ...
              in an amount equal to the market price of such property. The
              rights and obligations of the Parties set forth in Non-Compete,
              Confidentiality, Ownership of Work Product, Termination, and
              Miscellaneous are intended to survive termination, and will
            ...
            <div className="text-[20px] text-distlineColor font-arial mt-[14px] mx-7">
              ...
              <li>
                Notices: Any notice or other communication given or made to
                either Party under this Agreement shall be in writing and
                delivered by hand
              </li>
            </div>
          </div>
